...
<li><a href="register">Sign Up</a>
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
					...
					<li>
						<c:forEach items="${allData}" var="category">
 ...
 <div class="carousel-inner" role="listbox">
	...
	<div class="item active">
      ...
      <div class="item active">
        <img  src="http://afrishopen.com/media/wysiwyg/slideshow/home-default/slider-4.png" alt="mobile">
      </div>
      ...
      <div class="item">
        <img src="http://litbimg.rightinthebox.com/images/dfp/201610/mini_f606_81191_1_en.jpg?78" alt="mobile">
      </div>
